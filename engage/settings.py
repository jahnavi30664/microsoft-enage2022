...
SECRET_KEY = 'django-insecure-pckgbs*izknr8_)t(79wnj94812-7(r_7^$)dd-j$=j15!&xl8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['facereg.azurewebsites.net']
...
DATABASES = {
    'default': {
        ...
        'HOST' : 'engagepro.postgres.database.azure.com',
        'PORT': '5432',
    }
}
